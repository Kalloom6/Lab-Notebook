...
|Component       |Volume|   MM volume  |
|:--------------|----|-----------------|
| 5x SSIV Buffer | 4 $\mu$L | 132 $\mu$L      |
| SSIV RT        | 1 $\mu$L |    33 $\mu$L      |
| 100 mM DTT     | 1 $\mu$L |    33 $\mu$L      |
| RNAse Out      | 1 $\mu$L |     33 $\mu$L     |
...
|Component       |Volume|   MM volume  |
|:--------------|----|-----------------|
| Thermolabile Exonuclease I  | 1 $\mu$L |     33 $\mu$L     |
| NEBuffer r3.1*        | 2 $\mu$L |    66 $\mu$L      |
...
- 44 $\mu$L water/reaction

## WILDseq Primers
- Received WS primers from Kirsty Sawika

List primers/nmole/reconstituive volume

# Wednesday 21/11/2023
## WILDseq - Mouse Experiment 1: PCR1 Attempt 1
### Overview
...
|:--------------|----| ------- |
| 10uM WS_RT-PCR1_Fwd | 1.5 $\mu$L | 49.5 $\mu$L |
|10uM WS_RT-PCR1_Rev | 1.5 $\mu$L | 49.5 $\mu$L |
| DNAse/RNAse H20      | 12 $\mu$L | 396 $\mu$L |
| Kapa Hifi HotStart Ready Mix (2X) | 25 $\mu$L | 825 $\mu$L |
|||
| **Total Master Mix volume**|**40 $\mu$L** |
|||
| cDNA from above        | 10 $\mu$L | 
