...
- Plate seeding protocol:
  ...
  |Dilution ID| [RTX Well] | Media Volume | Source |  [RTX WS] |
  | :-------: | :------: |:-------: | :------: | :------: |
  | RTX 1 | 1 mg/mL | 1200$\mu$L | 800$\mu$L stock | 4 mg/mL |
  | RTX 2 | 500 $\mu$g/mL | 1 mL | 1 mL RTX 1 | 2 $\mu$g/mL |
  | RTX 3 | 250 $\mu$g/mL | 1 mL | 1 mL RTX 2 | 1 $\mu$g/mL |
  | RTX 4 | 125 $\mu$g/mL | 1 mL | 1 mL RTX 3 | 5 $\mu$g/mL |
  | RTX 5 | 62.5 $\mu$g/mL | 1 mL | 1 mL RTX 4 | 2.5 $\mu$g/mL |
  | RTX 6 | 31.25 $\mu$g/mL | 1 mL | 1 mL RTX 5 | 1.25 $\mu$g/mL |
...
p <- p + geom_text(data = df2, aes(x = col, y = row, label = paste0(value)), size = 2,)
p <- p +
  labs(title = "96 Well Plate Map Example", subtitle = EC50_ID, x = "Col", y = "Row") + 
  #theme_prism("waves") + 
  theme(panel.grid.major = element_blank(),
        panel.grid.minor = element_blank())
print(p, max.levels = NULL, width = 2)
