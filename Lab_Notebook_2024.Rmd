...
excel_data <- read_excel("~/Library/CloudStorage/OneDrive-UniversityofCambridge/Lab Notebook/Data/Drug Dilution Tables/240726_DDT.xlsx", sheet = "Sheet3")

columns_to_format <- c("Cell Line", "Cell Count", "Required Cell total")
...
## EC50 RTX RAMOS-DP3 240726 - Seeding
- Seeded an EC50 experiment comparing the effects of RTX on Cx/Rx-DP1 cell lines in the prescense of 25% NHS 
- Seeded 3 plates each with a different RAMOS-DP line 
- Used Rixathon (Catalogue#: )
...
excel_data <- read_excel("~/Library/CloudStorage/OneDrive-UniversityofCambridge/Lab Notebook/Data/Drug Dilution Tables/240726_DDT.xlsx", sheet = "Sheet2")
...
```{r, echo=FALSE}
df <- read_xlsx("~/Library/CloudStorage/OneDrive-UniversityofCambridge/Lab Notebook/Data/Lab Notebook - Table excel files/240726_PM.xlsx", sheet = "Sheet1")
title <- "EC50 CDC Test N2 + RAMOS 240719"
